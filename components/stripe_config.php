...
define('STRIPE_SUCCESS_URL', 'http://localhost/medimart/checkout.php'); //Payment success URL 
define('STRIPE_CANCEL_URL', 'http://localhost/medimart/payment-cancel.php'); //Payment cancel URL 
